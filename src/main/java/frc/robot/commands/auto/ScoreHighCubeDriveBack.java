...
public class ScoreHighCubeDriveBack extends SequentialCommandGroup {
  ...
  public ScoreHighCubeDriveBack(RobotContainer robotContainer) {
    ...
    addCommands(
      ...
      robotContainer.armUtils.getMotionCommand(ARM_STATE.HIGH, GAME_PIECE.CUBE, PIVOT_DIRECTION.FORWARD),
      new EjectObject(robotContainer).withTimeout(0.5),
