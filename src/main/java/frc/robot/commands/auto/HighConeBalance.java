...
public class HighConeBalance extends SequentialCommandGroup {
  /** Creates a new autoBalanceSequence. */

  public HighConeBalance(RobotContainer robotContainer) {
    ...
    addCommands(
      ...
      robotContainer.armUtils.getMotionCommand(ARM_STATE.HIGH, GAME_PIECE.CONE, PIVOT_DIRECTION.REVERSE),
